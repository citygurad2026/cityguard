      ...
      <div className="relative h-[500px] md:h-[600px] overflow-hidden rounded-2xl">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-600">
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-6 text-center">
            ...
            <button className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-full text-lg font-bold transition-all duration-300 transform hover:scale-105">
              ابدأ الآن
            </button>
          </div>
        </div>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute inset-0">
            ...
            {/* Overlay متدرج - ألوان زرقاء */}
            <div className="absolute inset-0 bg-gradient-to-r from-blue-900/70 via-blue-800/50 to-blue-600/30" />
          ...
          <div className="relative h-full flex items-center">
            <div className="container mx-auto px-6 md:px-12">
              ...
              >
                <div
                  className="bg-gradient-to-br from-blue-500/60 to-emerald-600/60 
                      backdrop-blur-md 
            ...
            <div className="absolute bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-3">
              {banners.map((_, index) => (
                ...
                >
                  ...
                  />
                  {index === currentBanner && (
                    <div className="absolute -inset-1.5 border border-blue-400/50 rounded-full animate-pulse" />
                  )}
                </button>
              ))}
            </div>
