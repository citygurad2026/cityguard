...
export default function OwnerCreateAdPage() {
  ...
  // حالة النموذج - مبسطة للـ OWNER
  const [formData, setFormData] = useState({
    title: "",
    content: "",
    bannerType: "MAIN_HERO",
    targetType: "BUSINESS", // ثابت للـ OWNER
    targetId: "",
    startAt: "",
    endAt: "",
    ctaText: "",
 ...
 useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // إضافة البيانات النصية - تلقائياً status: "PENDING_REVIEW" في الـ backend
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">أضف إعلاناً جديداً لمتجرك</p>
              </div>
            </div>
            <div className="flex items-center gap-2 text-sm text-blue-600 bg-blue-50 px-3 py-2 rounded-lg">
              <AlertCircle className="w-4 h-4" />
              <span>سيتم إرسال الإعلان للمراجعة</span>
            </div>
          </div>
        </motion.div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-600">
                            الإعلان سيكون خاص بمتجرك الوحيد
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <ul className="text-blue-700 text-sm space-y-1">
                <li>• سيتم إرسال الإعلان للمراجعة من قبل فريق الإدارة</li>
                <li>• ستصلك إشعار عند الموافقة على الإعلان</li>
                <li>• يجب أن تكون الصور بجودة عالية وواضحة</li>
                <li>• تأكد من صحة الروابط قبل الإرسال</li>
              </ul>
            </div>
          </div>
        </motion.div>
